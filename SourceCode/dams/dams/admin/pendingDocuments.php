  ...
  <!-- Content Wrapper -->
    ...
    <!-- Page Heading -->
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card border-primary rounded-lg shadow-lg mb-4">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    <a href="pending.php?id=<?php echo $taskid;?>&status_id=<?php echo $status_id;?>" class="btn btn-primary btn-sm">Upload</a>
                    <a href="navigator.php?name=<?php echo $taskName; ?>?>" class="btn btn-outline-primary btn-sm">View Task</a>
                </div>
            </div>
        </div>
    </div>
