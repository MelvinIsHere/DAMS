...
<body>
  ...
  <!-- Content Wrapper -->
    ...
    <center><h1 class="h3 mb-1 text-gray-800"><strong>Class Schedule Submission Monitoring</strong></h1></center>
    <div class="card-body">
                    ...
                    <tbody>
                        <?php
                            ...
                            $sql = "SELECT DISTINCT
                                                    ...
                                                    WHERE task_name = 'Faculty Loading' AND CONCAT(dp.department_name,dp.department_abbrv,u.type,u.email) LIKE '%$search%'
                                                    AND u.type != 'Staff'
                                                    GROUP BY u.user_id";
        ...
        break;
                            ...
                            $result_count = mysqli_query($conn, "SELECT
                                    ...
                                    FROM departments dp
                                                    ...
                                                    LEFT JOIN file_table f ON f.file_owner_id = u.user_id
                                                    LEFT JOIN document_templates dt ON dt.doc_template_id = t.document_id
                                                    WHERE task_name = 'Class Schedule' AND u.type != 'Staff'
                                                    GROUP BY u.user_id");
                            $total_records = mysqli_fetch_array($result_count);
                            $total_records = $total_records['total_records'];
                            $total_no_of_page = ceil($total_records / $total_records_per_page);
                        ...
                        <tr>
                            ...
                            <td style="display: inline-flex; ">
                                <a href="../view_files.php?id=<?php echo $file_id;?>&due_date=<?php echo $due_date?>&status_id=<?php echo $status_id;?>" class="btn btn-success" style="margin-right: 10px">View</a>
                                <a href="../return.php?id=<?php echo $status_id ?>&task_name=Accomplishment%20Report&user_id=<?php echo $user_id; ?>" class="btn-warning btn">Return</a>
                            </td>
                        </tr>
                    <?php 
