...
<div class="container-fluid tabcontent" id="createfill-Up">
                    <center><h1 class="h3 mb-1 text-gray-800"><b>FACULTIES</h1></b></center>
                            ...
                            $result_count = mysqli_query($conn, "SELECT
                                  COUNT(*) AS total_records
                                   ...
                                   FROM faculties
                                    ...
                                    AND CONCAT(firstname,lastname,middlename,suffix) LIKE '%$search%'
                         ...
                         ?>
                           <tr>
                            ...
                            <td style="display: inline-flex;">
                                 <a href="faculty_schedule_individual.php?faculty_name=<?php echo $faculty_name; ?>" ><i class="fas fa-eye"></i></a>
