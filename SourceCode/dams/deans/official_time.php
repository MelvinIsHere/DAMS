                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col d-flex justify-content-start">
                              ...
                              <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add Official time</span></a>
                        </div>
                        <div class="col d-flex justify-content-start">
...
<!-- Delete Modal -->
    ...
    <div id="addEmployeeModal" class="modal fade">
        <div class="modal-dialog modal-fullscreen-sm-down">
            <div class="modal-content">
                <form method="POST" action="../php/insert_official_time.php">
                    <div class="modal-header">                      
                        <h4 class="modal-title">Add Official Schedule</h4>
                        <input list="lnames" name="faculty_name" id="lname" value="<?php echo $_GET['faculty_name'] ?>" style="width: 0px;height: 0px; display: none;">
                        <input list="lnames" name="department_id" hidden value="<?php echo $department_id; ?>" style="width: 0px;height: 0px; ">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    </div>
                    <div class="modal-body">     
                     <div class="form-group">
                             <label for="descriptions" class="form-label">Schedule</label>
                                     <select id="descriptions" name="day_sched" onchange="toggleCourseCodeInput()" class="form-control">
                                        
                                        <option >Official time morning</option>
                                        <option >Official time afternoon</option>
