        ...
        $nextRow = $row + 1;
         ...
         $totalUnits = $totalUnits + $units;
          ...
          if($cRow == 7){
                   ...
                   $spreadsheet->getActiveSheet()
                        ->setCellValue('A' . $row, $cellValue)
                        ->setCellValue('D' . $row, "TOTAL")
                        ->setCellValue('G' . $row, $totalUnits);

                        //reset value of total units

                        $totalUnits = 0;
                    //merge row --- value total
                    // $spreadsheet->getActiveSheet()->mergeCells('D'.$row.':F'.$row);
            ...
            $rowCount++;
             ...
             if ($cellValue ==  $nextvalue) {
                  ...
                  // ...
                    ...
                    $totalUnits = 0;
                    $new = $spreadsheet->getActiveSheet()->getCellByColumnAndRow(1, $row)->getCalculatedValue();
                    if($new == $cellValue){
