...
<div class="container-fluid tabcontent" id="createfill-Up">
    <center><h1 class="h3 mb-1 text-gray-800"><b>CLASS SCHEDULE</h1></b></center>
    <div class="card-body">
                ...
                <div class="table-title">
                    <div class="row">
                        <div class="col d-flex justify-content-start">
                             <a href="../php/automation_documents/generate_class_schedule.php?dept_id=<?php echo $department_id?>&dept_abbrv=<?php echo $department_abbrv?>&department_name=<?php echo $department_name;?>&term_id=<?php echo 
                             $term_id?>" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Create Document</span></a>
                         </div>
                          <div class="col d-flex justify-content-start">
                    ...
                    <tbody>
                        <?php
                            ...
                            $result_count = mysqli_query($conn, "SELECT
                                ...
                                LEFT JOIN departments d ON d.department_id = p.department_id
                                    ...
                                    AND CONCAT('BS',p.program_abbrv,' ',s.section_name) LIKE '%$search%'
                        ...
                        <tr>
                            ...
                            <td><?php echo $section;?></td>
                                                     ...
                                                     <td>
                                   <a href="class_schedule_individual.php?section_name=<?php echo $section; ?>" ><i class="fas fa-eye"></i></a>
                            </td>
                        </tr>
                    <?php 
...
<!-- Delete Modal -->
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <form id="delete_loading" action="../php/delete_class_schedule.php" method="POST">
                    <div class="modal-header">
                ...
                <form method="POST" action="../php/insert_new_class_schedule.php">
                    ...
                    <div class="modal-body">                    
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                             <label for="browser" class="form-label">Room</label>
                                    <input class="form-control" list="rooms" name="room_name" id="room" placeholder="Choose a room">
                                    <datalist id="rooms">
                                        <?php 
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6">
                                <div  class="form-group">
                                    ...
                                    <input class="form-control"  name="time_start" id="time_s" placeholder="Time Start" type="time">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                 <div class="form-group">
                                    ...
                                    <input class="form-control"  name="time_end" id="time_e" placeholder="Time End" type="time" id="time_s">
