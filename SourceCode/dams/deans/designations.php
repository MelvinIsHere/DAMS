...
<div class="container-fluid tabcontent" id="createfill-Up">
    <h1 class="h3 mb-1 text-gray-800">Faculty Designations</h1>
    <div class="card-body">
                ...
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col d-flex justify-content-start">
                            <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add designation to Faculty Member</span></a>                                                                              
                        </div>
                         <div class="col d-flex justify-content-start">
                    ...
                    <tbody>
                        <?php
                            ...
                            $result_count = mysqli_query($conn, "SELECT
                                    ...
                                    WHERE fd.designation_id IS NOT NULL
                                    AND f.department_id = '$department_id'
                                    AND CONCAT(f.firstname,f.middlename,f.lastname,f.suffix, d.designation) LIKE '%$search%'");
...
<!-- end of table responsive -->
                            ...
                            <script type="text/javascript">
                                ...
                                $('.edit').on('click',function(){
                                    ...
                                    $('#designation_id_edit').val(designation_id);;
                                ...
                                $('.delete').on('click',function(e){
                                    ...
                                    var faculty_title_id  = $(this).closest('tr').find('.designation_id').text();
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <form id="update_title" action="../php/update_designation.php" method="POST">
                ...
                <div class="modal-body" id="editModal-body">
                    ...
                    <input type="text" id="designation_id_edit" hidden name="faculty_designation_id">
                    <input type="text" name="type" value="<?php echo $type?>" hidden>
                  <label for="faculty_title" class="form-label">Designation</label>
...
<!-- Delete Modal -->
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <form id="delete_title" action="../php/delete_designation.php" method="POST">
                    <div class="modal-header">
                    
                    <h5 class="modal-title" id="exampleModalLabel">Delete</h5>
                </div>
                <div class="modal-body" id="deleteModal-body">
                    <input type="text" name="faculty_designation_id" id="delete_id" hidden>
                    <input type="text" name="type" value="<?php echo $type;?>" hidden>
    ...
    <div id="addEmployeeModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="../php/add_designation.php">
                    <div class="modal-header">                      
                        <h4 class="modal-title">Add designation to a faculty member</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    </div>
                    <div class="modal-body">                    
                        <div class="form-group">
                            <label for="lname" class="form-label">Faculty</label>
                            <input class="form-control" name="type" value="<?php echo $type;?>" hidden>
