...
$contentStartRow_temp = 0;
$currentContentRow_temp = 0;
if($permanent){
    $contentStartRow_temp = $currentContentRow + 1;
    $currentContentRow_temp = $currentContentRow + 1;
}else{
    $contentStartRow_temp = 11;
    $currentContentRow_temp = 11;
}
$cellValueOld = "";
$worksheet = $spreadsheet->getActiveSheet();
...
$contentStartRow_part = 0;
$currentContentRow_part = 0;
if($temporary){
    $contentStartRow_part = $currentContentRow_temp + 1;
    $currentContentRow_part = $currentContentRow_temp + 1;
}else{
    $contentStartRow_part = 15;
    $currentContentRow_part = 15;
}
