<?php 
function get_faculty_id_by_name($faculty_name){
	include "config.php";

	$sql = mysqli_query($conn,"SELECT faculty_id FROM faculties WHERE CONCAT(lastname, ' ' , firstname, ' ',middlename,' ',suffix) = '$faculty_name'");
