...
$day = $_POST['day'];
$time_start = $_POST['time_s'];
$time_end = $_POST['time_e'];
$faculty_name = $_GET['faculty_name'];
$department_id = $_POST['department_id'];
$administrative_id = $_POST['loading_id'];
...
echo "deptid is $department_id and day  $day start at $time_start and end at $time_end and will be $faculty_name";
...
WHERE fs.faculty_id = '$faculty_id' AND d.department_id = '$department_id';
";
...
while ($row = mysqli_fetch_array($administrative_hours_conflict_sql_result)) {
	...
	header("Location: ../deans/administrative_hours.php?faculty_name=$faculty_name");
		...
		$update_administrative_hrs_sql = "UPDATE administrative_hours SET time_start_id = '$time_start_id_to_be_inserted', 
		time_end_id = '$time_end_id_to_be_inserted',day = '$day' WHERE administrative_hrs_id = '$administrative_id'";

		$result = mysqli_query($conn,$update_administrative_hrs_sql);
		if($result){
