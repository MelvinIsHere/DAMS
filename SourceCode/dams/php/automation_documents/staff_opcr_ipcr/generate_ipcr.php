...
if(mysqli_num_rows($user_text)>0){
       ...
       $spreadsheet->getActiveSheet()
                     ->setCellValue('A5', "      I, $name Staff of the $dept_name commit to deliver and agree to be rated on the attainment of the following targets in accordance with the indicated measures for the period ___________________ to ________________");
}
...
$spreadsheet->getActiveSheet()
                     ...
                     ->setCellValue('E41',$supervisor)
                     ->setCellValue('J41',$supervisor);
// $query = " SELECT 
//        f.`firstname`,
//        f.lastname,
//        f.middlename,
...
$cellvalue = "";
$row_start_strat_supp = $row_start;
$row_start_strat_supp_content = $row_start;
...
header('Content-Disposition: attachment;filename="IPCR '.$facultyname.'.xlsx"');
