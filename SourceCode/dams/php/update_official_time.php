...
$amPm_start = substr($start, -2);
$amPm_end = substr($end, -2);
...
$query = mysqli_query($conn,"UPDATE official_time SET time_start = '$start', time_end = '$end' WHERE official_id = '$update_id'");
if($query){
