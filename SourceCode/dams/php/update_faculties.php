...
if($type == "Permanent"){
			...
			if($sql){
				header("Location: ../deans/faculties_management.php?Message : ".$facultyname . " has been successfully updated!");
			}
			else{
				header("Location: ../deans/faculties_management.php?Message : Update failed!");
			}
		}
