...
if(!empty($department_id)){
	if($type == "Permanent"){
		...
		if($sql){
			header("Location: ../heads/faculties_management.php?Message: faculty successfully added");
		}else{
			header("Location: ../heads/faculties_management.php?Message: faculty adding failed");
		}
	...
	header("Location: ../heads/faculties_management.php?Message : Insert Failed!");
}
