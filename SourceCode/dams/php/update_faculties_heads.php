...
if($type == "Permanent"){
			...
			if($sql){
				header("Location: ../heads/faculties_management.php?Message : ".$facultyname . " has been successfully updated!");
			}
			else{
				header("Location: ../heads/faculties_management.php?Message : Update failed!");
			}
		}
