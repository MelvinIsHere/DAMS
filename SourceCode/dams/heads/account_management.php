...
<div class="container-fluid tabcontent" id="createfill-Up">
                    <h1 class="h3 mb-1 ml-3 text-gray-800">Account Management</h1>
                ...
                <table class="table table-striped table-hover" id="table">
                    ...
                    <tbody>
                        <?php
                            ...
                            COUNT(*)  AS total_records FROM users u 
                                LEFT JOIN faculties f ON f.`faculty_id` = u.faculty_id
                                LEFT JOIN departments dp ON dp.`department_id` = f.`department_id`
                                LEFT JOIN designation d ON d.designation_id = f.designation_id
                                WHERE dp.department_id = '$department_id'
                                AND CONCAT(u.email,u.type) LIKE '%$search%'");
            ...
            <div class="modal-content">
                <form id="update_account" action="../php/update_account.php" method="POST">
                    ...
                    <div class="modal-header">
                        ...
                        <input type="text" name="type_of_editor" value="<?php echo $type_acc;?>" id="account_sty" hidden>
                    </div>
...
<!-- ########################################################################################################################## -->
                     <div class="form-group">
                             <label for="type" class="form-label">Type</label>
                                    <input class="form-control" list="browsers" name="type" id="account_type" placeholder="Choose a faculty type" required>
...
<!-- Delete Modal -->
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" id="deleteModal-body">
                    ...
                    <input type="text" hidden name="type"  value="<?php echo $type_acc; ?>" hidden>
    ...
    <div id="addEmployeeModal" class="modal fade">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <form method="POST" id="account" action="../php/signup.php" enctype="multipart/form-data">
                    <div class="modal-header">                      
                    ...
                    <div class="modal-body"> 
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="type_of_creator" value="<?php echo $type_acc;?>" hidden>
                        ...
                        <div class="form-group">
                            ...
                            <input type="" name="faculty"class="form-control" required list="faculty_name">
                             <datalist id="faculty_name">
                                        <?php 
                                            $sql = "SELECT * FROM faculties WHERE department_id = '$department_id'";
