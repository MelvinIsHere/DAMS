    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <form id="update_title" action="../php/update_faculty_titles_heads.php" method="POST">
...
<!-- Delete Modal -->
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <form id="delete_title" action="../php/remove_faculty_title_heads.php" method="POST">
                    <div class="modal-header">
    ...
    <div id="addEmployeeModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="../php/add_new_title_to_faculty_member_heads.php">
                    <div class="modal-header">                      
