                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <?php
                            ...
                            COUNT(*)  AS total_records FROM sections s
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form id="update_section" action="../php/update_section_heads.php" method="POST">
...
<!-- Delete Modal -->
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <form id="delete_section" action="../php/delete_section_heads.php" method="POST">
                    <div class="modal-header">
    ...
    <div id="addEmployeeModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="../php/add_section_heads.php">
                    <div class="modal-header">                      
