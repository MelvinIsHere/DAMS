...
<div class="container-fluid tabcontent" id="createfill-Up">
    <h1 class="h3 mb-1 text-gray-800">Positions</h1>
    <div class="card-body">
                ...
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col d-flex justify-content-start">
                            <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Position</span></a>                                                                              
                        </div>
                             <div class="col d-flex justify-content-start">
                    ...
                    <tbody>
                        <?php
                            ...
                            $result_count = mysqli_query($conn, "SELECT
                                    ...
                                    WHERE title_description LIKE '%$search%'");
                         ...
                         ?>
                        <tr>
                            <td class="title_id"><?php echo $id;?></td>
                            ...
                            <script type="text/javascript">
                                ...
                                $('.edit').on('click',function(){
                                    ...
                                    console.log(data);
                                     ...
                                     var title_id  = $(this).closest('tr').find('.title_id').text();
                                    console.log(title_id)
                                    $('#position_id').val(title_id);;
                                ...
                                $('.delete').on('click',function(e){
                                    ...
                                    var designation_id  = $(this).closest('tr').find('.title_id').text();
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <form id="update_program" action="../php/update_position.php" method="POST">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit position</h5>
                </div>
                <div class="modal-body" id="editModal-body">
                    <div class="form-group">
                        <label for="faculty_name" class="form-label"> Position name</label>
                        <input type="text" name="position_id" id="position_id" hidden >
                        <input class="form-control" name="position_name" id="position_name" placeholder="Enter position name ">
                    </div>
               </div>
...
<!-- Delete Modal -->
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <form id="delete_program" action="../php/delete_position.php" method="POST">
                    <div class="modal-header">
                    
                    <h5 class="modal-title" id="exampleModalLabel">Delete</h5>
                </div>
                <div class="modal-body" id="deleteModal-body">
                    <input type="" name="position_id" id="delete_id" hidden>
    ...
    <div id="addEmployeeModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="../php/add_new_position.php">
                    <div class="modal-header">                      
                    ...
                    <div class="modal-body">                    
                        <div class="form-group">
                            <label for="program_name" class="form-label">Position Name</label>
                                    <input class="form-control" name="position_name"  placeholder="Enter position name" required>                                
                        </div>
