                    ...
                    <tbody>
                        <?php
                            ...
                            $result_count = mysqli_query($conn, "SELECT
                                    ...
                                    LEFT JOIN faculties f ON f.`faculty_id` = ft.fac_title_id
                                    LEFT JOIN departments d ON d.department_id = f.department_id
                                    LEFT JOIN titles t ON t.`title_id` = ft.title_id
                                    WHERE CONCAT(f.firstname,f.middlename,f.lastname,f.suffix,d.department_name,t.title_description) LIKE '%$search%'");
...
<!-- Delete Modal -->
    ...
    <div id="addEmployeeModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="../php/add_new_title_to_faculty_member_admin.php">
                    <div class="modal-header">                      
