...
<body>
  ...
  <!-- Content Wrapper -->
    ...
    <center><h1 class="h3 mb-1 text-gray-800"><strong>Room Utilization Matrix Monitoring</strong></h1></center>
    <div class="card-body">
                    ...
                    <tbody>
                        <?php
                            ...
                            $sql = "SELECT DISTINCT
                                                    ...
                                                    WHERE task_name = 'Room Utilization Matrix' AND u.type != 'Staff'
                        ...
                        <tr>
                            ...
                            <td style="display: inline-flex; ">
                                ...
                                <a href="../return.php?id=<?php echo $status_id ?>&task_name=<?php echo $task_name;?>&user_id=<?php echo $user_id; ?>" class="btn-warning btn">Return</a>
                            </td>
                        </tr>
                    <?php 
    ...
    if ($count > $total_records_per_page) {
        break;
                            ...
                            $result_count = mysqli_query($conn, "SELECT 
                                ...
                                WHERE t.task_name = 'Room Utilization Matrix'
                                GROUP BY u.user_id");
