    ...
    echo "success";
            ...
            if ($result) {
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    $query = mysqli_query($conn,"INSERT INTO task_status_deans (task_id, office_id,user_id, is_completed) VALUES ('$id', '$dept_id','$users_id', 1)");
                     $last_id = $conn->insert_id;
                    echo "inserted to $users_id and taskid $id  department $dept_id last id $last_id";
