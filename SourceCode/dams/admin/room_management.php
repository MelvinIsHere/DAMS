                ...
                <table class="table table-striped table-hover" id="table">
                    ...
                    <tbody>
                        <?php
                         ...
                         ?>
                        <tr>
                            <td class="room_id"><?php echo $id;?></td>
                            ...
                            <script type="text/javascript">
                                ...
                                $('.edit').on('click',function(){
                                    ...
                                    console.log(data);
                                     ...
                                     var room_id  = $(this).closest('tr').find('.room_id').text();
                                    console.log(room_id)
                                    $('#room_id').val(room_id);;
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <form id="update_program" action="../php/update_room.php" method="POST">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit room</h5>
                </div>
                <div class="modal-body" id="editModal-body">
                    <div class="form-group">
                        <label for="faculty_name" class="form-label"> Room Name</label>
...
<!-- Delete Modal -->
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <form id="delete_program" action="../php/delete_room.php" method="POST">
                    <div class="modal-header">
                    
                    <h5 class="modal-title" id="exampleModalLabel">Delete</h5>
                </div>
                <div class="modal-body" id="deleteModal-body">
                    <input type="" name="room_id" id="delete_id" hidden>
    ...
    <div id="addEmployeeModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="../php/add_new_room.php">
                    <div class="modal-header">                      
                    ...
                    <div class="modal-body">                    
                        <div class="form-group">
                            <label for="program_name" class="form-label">Room Name</label>
                                    <input class="form-control" name="room_name" id="room_name" placeholder="Enter room name" required>                                
                        </div>
