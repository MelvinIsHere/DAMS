                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                              <h6> <strong> Completed Task</strong></h6></div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <center>
                                                    <?php
                                                        $pending_count = mysqli_query($conn,"  SELECT
    ...
    <div class="card shadow mb-4">
        ...
        <?php
            ...
            while($row = mysqli_fetch_array($result)){
                ...
                }elseif($task_name == 'OPCR'){
                    $opcr_percent = $percentage;
                }
            
            }
            if($facLoadingPercent < 0 && $classSchedPercent < 0 && $facultyScehdPercent < 0 && $facultyScehdPercent < 0 && $room_utilization_matrix_percent < 0 && $opcr_percent <0){
                ?>
        ...
        <?php
         ...
         <?php
          ...
          ?>
            ...
            <div class="progress mb-4" style="width: 100%;"> <!-- Set the width to 100% to span the entire container -->
                <div class="progress-bar " role="progressbar" style="background-color:#00BFA5;width:
                <?php
     ...
     <?php
            ...
            if($opcr_percent >= 0 && $opcr_percent <= 99){
                ?>
                    <div class="card-body">
            <h4 class="small font-weight-bold">Office Performance Commitment Report<span class="float-right">
                <?php
                //percent here
                echo $opcr_percent ."%";
                ?>
