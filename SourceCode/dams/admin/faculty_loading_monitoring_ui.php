  ...
  <!-- Content Wrapper -->
                        ...
                        <tr>
                            <td><?php echo $user_id;?></td>
                             ...
                             <td>
                                ...
                                <a href="../return.php?id=<?php echo $status_id ?>&task_name=<?php echo $task_name;?>&user_id=<?php echo $user_id; ?>&file_id=<?php $file_id;?>" ><i class="material-icons" data-toggle="tooltip">reply</i></a>
                            </td>
                        </tr>
                    <?php 
    ...
    if ($count > $total_records_per_page) {
        break;
                            ...
                            $result_count = mysqli_query($conn, "SELECT 
                                ...
                                WHERE t.task_name = 'Faculty Loading'
                                GROUP BY u.user_id");
    ...
    if ($total_no_of_page <= 10) {
        ...
        if ($page_no <= 4) {
            ...
            echo "<li class='page-item'><a href='?page_no=$second_last&search={$_GET["search"]}'>$second_last</a></li>";
